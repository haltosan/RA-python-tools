...
output_name = "spacy_test"

# Name of the csv file to write to
target = f"{output_name}.csv"

# PUT INPUT FOLDER HERE
INPUT_PATH = r'V:\FHSS-JoePriceResearch\papers\current\tree_growth\US\Skagit\skagit_obits\2_NLP\Spacy_Input'

# PUT OUTPUT FOLDER HERE
OUTPUT_PATH = r'V:\FHSS-JoePriceResearch\papers\current\tree_growth\US\Skagit\skagit_obits\2_NLP\Spacy_Output'
